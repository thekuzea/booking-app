...
interface TripRepository {
    ...
    @Query(
            value = "{'tripClassType': ?0, 'countryCodeOfDeparture': ?1, 'cityOfDeparture': ?2, 'departureDateTime': ?3, 'countryCodeOfArrival': ?4, 'cityOfArrival': ?5, 'dateTimeOfArrival': ?6, 'planeId': ?7}",
            exists = true
    )
